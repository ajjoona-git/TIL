...
## 코드 파일 보러가기 → [![GitHub Repository](https://img.shields.io/badge/GitHub-ajjoona--git/pjt--07-yellow?style=flat&logo=github)](https://github.com/ajjoona-git/pjt-07)
...
- 전체 배우 목록 조회
![Actor List](../images/07_1.png)
- 특정 배우 정보와 출연 영화 조회
![Actor Detail](../images/07_2.png)

### Movie

- 전체 영화 목록 조회
![Movie List](../images/07_3.png)
- 특정 영화 정보 + 배우 목록 + 리뷰 목록 조회
![Movie Detail](../images/07_4.png)
- 특정 영화에 대한 리뷰 생성
![Create Review](../images/07_5.png)

### Reviews

- 전체 리뷰 목록 조회
![Review List](../images/07_6.png)
- 리뷰 단일 조회
![Review Detail - GET](../images/07_7.png)
- 리뷰 단일 삭제
![Review Detail - DELETE](../images/07_8.png)